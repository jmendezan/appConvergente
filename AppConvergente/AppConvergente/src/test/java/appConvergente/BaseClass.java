package appConvergente;

import appConvergente.exceptions.FrontEndException;
import appConvergente.utility.*;
...
public class BaseClass {
    ...
    //private static long defaultWaitingTime;
    public static int defaultWaitingTime = 250;
    public static  ScreenshotUtility screenshotUtility = new ScreenshotUtility();
    ...
    public static void click(WebDriver driver, String key, String locator) throws Throwable {
        try {
            System.out.println("enclick_key:"+key);
            System.out.println("enclick_locator:"+locator);
            WebDriverWait wait = new WebDriverWait(driver, defaultWaitingTime);
            WebElement element = null;

                element = wait.until(ExpectedConditions.visibilityOfElementLocated(ObjectMap.getLocator(locator)));
...
//        }
//    }
public static void takeScreenshot(WebDriver driver, String UIName) throws IOException, AWTException {
    screenshotUtility.takeScreenshotDriver(UIName, driver);
    //
}

    public WebElement wait(String UIName, String objTechName, WebDriver driver) throws Exception {
        WebDriverWait wait = new WebDriverWait(driver, defaultWaitingTime);
        WebElement element = null;
